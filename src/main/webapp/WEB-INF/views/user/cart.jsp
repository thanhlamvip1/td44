		...
		<div class="cart-page__cols">
			...
			<div class="cart-page__left">
				...
				<section class="promo">
					<div class="promo__top">
						<h3 class="promo__title">
							<s:message code="user.promocart" />
						</h3>
						<p class="promo__text">
							<s:message code="user.promocarttext" />
						</p>
					</div>
				...
				<div class="cart-socials socials">
					<span class="cart-socials__text socials__text">
						<s:message code="user.social" />
						:
					</span>
