							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<form:input type="text" path="username" cssClass="form-control" placeholder="username2022" />
											<span>
								...
								<div class="col-xl-6">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<form:input type="email" path="email" cssClass="form-control" placeholder="abc@example.com" />
											<span>
